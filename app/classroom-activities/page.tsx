    ...
    <div>
      ...
      <div className="db-card db-card-lavender" style={cardStyle}>
        <div style={sectionHeader}>
          <div>
            <h3 style={sectionTitle}>Learners Needing Support</h3>
            <p style={smallHint}>
              {isTeacher ? "Support cases for your classroom." : "Open learner support cases across the school."}
            </p>
          </div>

          <Link href={schoolParam ? `/support-register?school=${schoolId}` : "/support-register"} className="db-button-primary" style={smallButton}>
