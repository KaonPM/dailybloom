...
export default function DataMigrationPage() {
  ...
  return <div style={{ display: "grid", gap: 14 }}>
    <section className="db-page-header db-card-blue"><p className="db-eyebrow">School Administration</p><h1>Data Migration Centre</h1><p className="db-page-subtitle">Validate and import verified learner data.</p><div className="db-page-actions"><Link className="db-button-secondary" href="/school-administration">Back to School Administration</Link><button className="db-button-primary" type="button" onClick={downloadTemplate}>Download learners.csv template</button></div></section>
