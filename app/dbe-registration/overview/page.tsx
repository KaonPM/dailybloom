...
export default function OverviewPage() {
  ...
  const attention = [
    [expiredRequirements + renewalSummary.expired, "Expired item needs attention", "/dbe-registration/certificates", "Expired"], [actionSummary.overdue, "Overdue corrective action", "/dbe-registration/corrective-actions", "Overdue"], [actionSummary.readyForVerification, "Action ready for verification", "/dbe-registration/corrective-actions", "Review"], [actionSummary.dueSoon, "Corrective action due this week", "/dbe-registration/corrective-actions", "View"], [missingRequirements + staffSummary.missing, "Missing compliance item", "/dbe-registration/requirements", "Missing"], [reviewRequirements, "Requirement needs review", "/dbe-registration/requirements", "Needs Review"], [renewalSummary.expiringSoon, "Item expiring soon", "/dbe-registration/certificates", "Expiring Soon"], [unlinkedDocuments, "Document needs to be linked to a requirement", "/dbe-registration/requirements", "Link Evidence"], [upcomingInspections.length, "Upcoming inspection", "/dbe-registration/inspections", nextInspection ? `Scheduled ${dateValue(nextInspection)}` : "View inspections"],
  ] as const;
