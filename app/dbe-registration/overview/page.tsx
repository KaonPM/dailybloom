...
import { calculateReadiness, correctiveActionState } from "@/app/lib/compliance";
...
type Overview = { registration: Row | null; requirements: Row[]; documents: Row[]; evidence: Row[]; staff: Row[]; active_staff_count: number; inspections: Row[]; findings: Row[]; actions: Row[]; certificates: Row[]; renewal_summary?: RenewalSummary };
