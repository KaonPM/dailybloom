    ...
    <div>
      ...
      >
        <div style={{ display: "flex", justifyContent: "space-between", gap: "12px", alignItems: "center", flexWrap: "wrap" }}>
          ...
          {selectedClassroomId && selectedLearnerId && selectedPeriodId ? <button className="db-button-primary" onClick={() => router.push(`/teacher-assessments?classroom=${encodeURIComponent(selectedClassroomId)}&learner=${encodeURIComponent(selectedLearnerId)}&period=${encodeURIComponent(selectedPeriodId)}`)}>Open Progress Review</button> : null}
          <button
            className="db-button-primary"
            style={{ background: "#777" }}
            onClick={() => {
