-- A completed activity is immutable.  This prevents a repeat RPC call from
-- replacing its support outcomes and, through the foreign key cascade,
-- removing the intervention history attached to those outcomes.
